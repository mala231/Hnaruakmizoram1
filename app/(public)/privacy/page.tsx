...
export default async function PrivacyPage() {
  ...
  const sections = [
    {
      num: "01",
      title: t("privacy.section_1_title", lang),
      icon: (
        <svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4" />
        </svg>
      ),
      content: t("privacy.section_1_desc", lang),
    },
    {
      num: "02",
      title: t("privacy.section_2_title", lang),
      icon: (
        <svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
        </svg>
      ),
      content: t("privacy.section_2_desc", lang),
    },
    {
      num: "03",
      title: t("privacy.section_3_title", lang),
      icon: (
        <svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
        </svg>
      ),
      content: t("privacy.section_3_desc", lang),
    },
    {
      num: "04",
      title: t("privacy.section_4_title", lang),
      icon: (
        <svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
        </svg>
      ),
      content: t("privacy.section_4_desc", lang),
    },
    {
      num: "05",
      title: t("privacy.section_5_title", lang),
      icon: (
        <svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
        </svg>
      ),
      content: t("privacy.section_5_desc", lang),
    },
  ];
      ...
      <div style={{ background: "linear-gradient(135deg,#071022 0%,#0f1b30 60%,#1c7dfa 100%)", padding: "64px 24px 80px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "760px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(255,255,255,0.15)", backdropFilter: "blur(8px)", border: "1px solid rgba(255,255,255,0.25)", borderRadius: "100px", padding: "6px 16px", marginBottom: "20px" }}>
            <svg width="12" height="12" fill="white" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
      ...
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "0 24px 80px", marginTop: "-32px", position: "relative", zIndex: 2 }}>
        ...
        <div style={{ background: "white", borderRadius: "20px", boxShadow: "0 8px 32px rgba(28,125,250,0.12)", border: "1px solid rgba(28,125,250,0.1)", padding: "24px 28px", marginBottom: "32px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
            {sections.map((s) => (
              <a key={s.num} href={`#prv-${s.num}`} style={{ fontSize: "13px", fontWeight: 600, color: "#1c7dfa", background: "#f0f9ff", border: "1px solid #bae6fd", borderRadius: "100px", padding: "5px 14px", textDecoration: "none" }}>
                {s.title}
              </a>
            ))}
          </div>
        ...
        <div style={{ background: "#f0f9ff", border: "1px solid #bae6fd", borderRadius: "16px", padding: "20px 24px", display: "flex", gap: "12px", alignItems: "flex-start" }}>
          ...
          <p style={{ fontSize: "13px", color: "#0c4a6e", margin: 0, fontWeight: 500, lineHeight: 1.7 }}>
            {lang === "mz" ? (
              <>
                Privacy dan zawhna emaw harsatna i neih chuan{" "}
                <Link href="/contact" style={{ color: "#1c7dfa", fontWeight: 700 }}>min be pawh rawh</Link>.
                I data security hi kan thlirin kan enkawl ang.
              </>
            ) : (
              <>
                If you have any questions or issues regarding our privacy policy, please{" "}
                <Link href="/contact" style={{ color: "#1c7dfa", fontWeight: 700 }}>contact us</Link>.
                We prioritize and safeguard your data security.
              </>
            )}
          </p>
        </div>
